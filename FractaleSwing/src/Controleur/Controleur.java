...
public class Controleur {
	...
	public void zoom () {
		...
		set_MANDELBROT_RE_MIN( m.getMANDELBROT_RE_MIN()-1 );
		set_MANDELBROT_RE_MAX( m.getMANDELBROT_RE_MAX()-1 );
		set_MANDELBROT_IM_MIN( m.getMANDELBROT_IM_MIN()-1 );
		set_MANDELBROT_IM_MAX( m.getMANDELBROT_IM_MAX()-1 );
